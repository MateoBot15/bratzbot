...
*https://www.instagram.com/mateo_ventas_*
┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈
...
/*conn.sendHydrated(m.chat, str, wm, media, 'https://github.com/GataNina-Li/GataBot-MD', '𝐌𝐚𝐭𝐞𝐨 𝐁𝐨𝐭 ☘️', null, null, [
['𝙂𝙧𝙪𝙥𝙤𝙨 𝙊𝙛𝙞𝙘𝙞𝙖𝙡𝙚𝙨 | 𝙂𝙧𝙤𝙪𝙥𝙨 🔰', '.grupos'],
['𝘾𝙧𝙚𝙖𝙙𝙤𝙧𝙖 | 𝘾𝙧𝙚𝙖𝙩𝙤𝙧 💗', '#owner'],
['𝙑𝙤𝙡𝙫𝙚𝙧 𝙖𝙡 𝙈𝙚𝙣𝙪́ | 𝘽𝙖𝙘𝙠 𝙩𝙤 𝙈𝙚𝙣𝙪 ☘️', '/menu']
], m,)}*/

handler.command = /^cuentasoficiales|mateoig|cuentasmb|cuentamb|accounts|mateoaccounts|account|igmateo|cuentasdemateo|cuentasdemateobot|cuentamateobot|cuentasmateobot$/i
handler.exp = 35

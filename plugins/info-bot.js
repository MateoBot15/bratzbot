...
`.trim()
const estilo = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "51929741688-1625305606@g.us" } : {}) },
message: { 
...
const estiloaudio = { key: {  fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "51929741688-1625305606@g.us" } : {}) },
message: { 

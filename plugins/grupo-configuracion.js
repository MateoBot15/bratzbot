...
let enlace2 = { contextInfo: { externalAdReply: { showAdAttribution: true, mediaUrl: yt, mediaType: 'VIDEO', description: '', title: wm, body: '𝐌𝐚𝐭𝐞𝐨 𝐁𝐨𝐭 ☘️ - 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽 ', thumbnailUrl: await(await fetch(img)).buffer(), sourceUrl: yt }}}
...
//conn.sendHydrated(m.chat, text, wm, img5, md, '𝐌𝐚𝐭𝐞𝐨 𝐁𝐨𝐭 ☘️', null, null, [

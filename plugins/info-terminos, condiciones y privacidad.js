...
let Terminos = `*_Toda la informacion que se mencione aqui no excluye a la Propietaria del Bot, y Propietarios Acredores al uso de MateoBot_*
...
_- El chat anonimo del comando #start, valga la redundancia no mostrará ningun dato de los Usuarios por parte de MateoBot. Eso no implica que las personas que hagan uso de esta funcion puedan dar a conocer sus datos. en Numero(s) Oficial(es)._

_- Los Datos que Obtenga MateoBot en Cuentas Oficiales de Usuarios(as), Grupos y Ajustes del Mismo puede verse Reiniciado, Modificado, y/o Retificado con el fin de que el Bot este en optimas Condiciones para su Uso. (Usuarios(as) Pueden Pedir Compensacion Por Instagram o por el comando #Reporte. Debe de Presentar Pruebas)._
...
_- Las Cuentas Oficiales de MateoBot no se hacen responsable del Uso que usted haga con la funci贸n "Sub Bot"._
...
~ _Solo en esta Cuenta Respondo si tiene Dudas, Preguntas o Necesita Ayuda sobre MateoBot, Tambien puede Comunicarse en Caso de Temas de Colaboracion_
*${ig}*
...
*~ Muchas Gracias Por tomarte el tiempo en informate sobre MateoBot*` 
await conn.sendFile(m.chat, pp, 'gata.mp4', Terminos)
/*.trim()
conn.sendHydrated(m.chat, Terminos,  `${wm}\nEstamos de acuerdo en Hacer Colaboraciones con Personas Comprometidas, manteniendo el Respeto Puedes Contactar si ese es el caso a esta Cuenta Oficial | https://www.instagram.com/mateo_ventas_`, pp, 'https://github.com/GataNina-Li/GataBot-MD', '饾檪饾櫀饾櫓饾櫀饾樈饾櫎饾櫓-饾檲饾樋', null, null, [
